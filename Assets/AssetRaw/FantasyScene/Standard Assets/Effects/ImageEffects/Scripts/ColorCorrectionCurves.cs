...
namespace UnityStandardAssets.ImageEffects
{
    ...
    public class ColorCorrectionCurves : PostEffectsBase
	{
        ...
        public float isShowGreen = 1;
        public float isShowYellow = 1;
        public float isShowBlue = 1;
        public float isShowRed = 1;
        public float isShowAll = 0;
        ...
        public float redStart = 0;
        public float greenStart = 0;
        public float blueStart = 0;
      ...
      //  private bool  updateTexturesOnStartup = true;
        ...
        private void UpdateCurve()
        {
            ...
            redChannel = new AnimationCurve(new Keyframe(0f, redStart), new Keyframe(1f, redEnd));
            greenChannel = new AnimationCurve(new Keyframe(0f, greenStart), new Keyframe(1f, greenEnd));
            blueChannel = new AnimationCurve(new Keyframe(0f, blueStart), new Keyframe(1f, blueEnd));
        }
        ...
        void OnRenderImage (RenderTexture source, RenderTexture destination)
		{
            ...
            else
			{
                ...
                ccMaterial.SetFloat("_isShowGreen", isShowGreen);
                ccMaterial.SetFloat("_isShowYellow", isShowYellow);
                ccMaterial.SetFloat("_isShowBlue", isShowBlue);
                ccMaterial.SetFloat("_isShowRed", isShowRed);
                ccMaterial.SetFloat("_isShowAll", isShowAll);
