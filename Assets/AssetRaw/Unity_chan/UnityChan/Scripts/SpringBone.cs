...
namespace UnityChan
{
	public class SpringBone : MonoBehaviour
	{
		...
		//Kobayashi:Thredshold Starting to activate activeRatio  阈值
		...
		{
			//缩放修正
			springLength = Vector3.Distance(trs.position, child.position)/ managerRef.gameObject.transform.localScale.x;
			currTipPos = child.position;
			prevTipPos = child.position;
		}

		//更新节点位置(根据位置变化的方向，让节点随着根节点旋转)
